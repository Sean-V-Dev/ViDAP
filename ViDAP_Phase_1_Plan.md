...
| Status | Approved |
| Version | 1.0 |
| Parent | ViDAP_Roadmap.md version 2.1 |
...
|---|---|---|---|
| WS1.1 Decision records | Resolve D1.1-D1.7 with evidence and durable tradeoffs | Phase 0 reconciliation | P1-EP01: workflow/compatibility decisions |
| WS1.2 Canonical document kernel | Implement the selected workflow document, identities, edges, and semantic/layout boundary | D1.1-D1.2 | P1-EP02: workflow model and serialization |
...
This plan is approved. Central may draft P1-EP01 — Workflow and Compatibility
Decisions. Each P1 packet requires its own explicit approval before execution;
plan approval alone authorizes no implementation.
